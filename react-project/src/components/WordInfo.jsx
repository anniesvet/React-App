...
function WordInfo (props) {
    ...
    return (
            <div className={ReadListStyles.wrapper}> 
                ...
                <div className={ReadListStyles.word}> {isEdit ? props.english : <input type="text" value={props.english} onChange={()=> {console.log(props.english)}} />} </div>
                <div className={ReadListStyles.word}>{isEdit ? props.transcription : <input type="text" value={props.transcription} onChange={()=> {console.log(props.transcription)}}/>}</div>
                <div className={ReadListStyles.word}>{isEdit ? props.russian : <input type="text" value={props.russian} onChange={()=> {console.log(props.russian)}} />}</div>
